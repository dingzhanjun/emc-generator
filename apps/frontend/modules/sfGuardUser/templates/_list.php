<div class="sf_admin_list">
  <?php if (!$pager->getNbResults()): ?>
    <p><?php echo __('Không tìm thấy', array(), 'sf_admin') ?></p>
  <?php else: ?>
    <table cellspacing="0">
      <thead>
        <tr>
          ...
          <th id="sf_admin_list_th_actions"><?php echo __('Tác vụ', array(), 'sf_admin') ?></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
          <th colspan="10">
            ...
            <?php echo format_number_choice('[0] không tìm thấy|[1] 1 kết quả|(1,+Inf] %1% kết quả', array('%1%' => $pager->getNbResults()), $pager->getNbResults(), 'sf_admin') ?>
            <?php if ($pager->haveToPaginate()): ?>
