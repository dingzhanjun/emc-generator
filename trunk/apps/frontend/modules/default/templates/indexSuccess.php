...
<div id='main_tabs'>
	<a href='<?php echo url_for('@config'); ?>' rel='<?php echo url_for('@config'); ?>' id='grounds_manager' class='tab_icon'><img src='/images/icon_system.png' /><div class='tab_label'>Config</div></a>
    <a href='<?php echo url_for('@loads'); ?>' rel='<?php echo url_for('@loads'); ?>' id='users_manager' class='tab_icon'><img src='/images/icon_trucks.png' /><div class='tab_label'>Loads</div></a>
    <a href='<?php echo url_for('@quick_search'); ?>' rel='<?php //echo url_for('@ground_order'); ?>' id='services_manager' class='tab_icon'><img src='/images/icon_search.png' /><div class='tab_label'>Quick Search</div></a>
<?
/*
